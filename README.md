...
- نمایش کارت‌های دو ستونه برای کتاب‌ها با عنوان و خلاصه‌ی کوتاه
- باز کردن فایل از حافظه از نوار بالایی
- دکمه‌ی «دونیت» که صفحه‌ی حمایت را در Chrome یا مرورگر پیش‌فرض باز می‌کند
- دانلود فایل PDF/BIN و باز کردنش داخل خود اپ با کتابخونه‌ی رسمی جتپک **androidx.pdf (نسخه‌ی beta)**
...
- با لمس خود کارت، متن کامل description در یک پنجره اسکرول‌دار نمایش داده می‌شود.
